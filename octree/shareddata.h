...
namespace Octree
{
    ...
    /**
     * \warning This class isn't thread-safe! In particular, we should use
     * atomic operations when incrementing or decrementing the reference
     * count. See Boost's shared_ptr for an alternative.
     */
    template< typename T >
        class SharedData
        {
