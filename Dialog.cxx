...
Dialog::Dialog()
{
  ...
  // palette editor
  editor = new Fl_Double_Window(624, 360, "Palette Editor");
  editor_h = new Widget(editor, 16, 16, 24, 256, "Hue", 24, 1, (Fl_Callback *)do_editor_get_hsv);
  editor_sv = new Widget(editor, 48, 16, 256, 256, "Saturation/Value", 1, 1, (Fl_Callback *)do_editor_get_hsv);
  editor_insert = new Fl_Button(312, 16, 96, 24, "Insert");
  editor_insert->callback((Fl_Callback *)do_editor_insert);
  editor_delete = new Fl_Button(312, 56, 96, 24, "Delete");
  editor_delete->callback((Fl_Callback *)do_editor_delete);
  editor_replace = new Fl_Button(312, 96, 96, 24, "Replace");
  editor_replace->callback((Fl_Callback *)do_editor_replace);
  editor_undo = new Fl_Button(312, 152, 96, 24, "Undo");
  editor_undo->callback((Fl_Callback *)do_editor_get_undo);
  editor_rgb_ramp = new Fl_Button(312, 208, 96, 24, "RGB Ramp");
  editor_rgb_ramp->callback((Fl_Callback *)do_editor_rgb_ramp);
  editor_hsv_ramp = new Fl_Button(312, 248, 96, 24, "HSV Ramp");
  editor_hsv_ramp->callback((Fl_Callback *)do_editor_hsv_ramp);
  editor_palette = new Widget(editor, 416, 16, 192, 192, "Palette", 24, 24, (Fl_Callback *)do_editor_palette);
  editor_color = new Widget(editor, 416, 224, 192, 48, "Color", 0, 0, 0);
  new Separator(editor, 16, 302, 616, 2, "");
  editor_done = new Fl_Button(512, 320, 96, 24, "Done");
