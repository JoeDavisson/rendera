...
#OBJS = Blend.o Bitmap.o Map.o Brush.o Tool.o Paint.o Airbrush.o PixelArt.o Stump.o Offset.o GetColor.o Crop.o Stroke.o View.o Widget.o Palette.o Button.o ToggleButton.o Field.o Separator.o Dialog.o Gui.o quantize.o check.o load.o save.o main.o
