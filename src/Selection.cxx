...
void Selection::copy(View *view)
{
  ...
  Gui::selection->pasteEnable(true);
  Gui::selection->cropEnable(false);
...
void Selection::paste(View *view)
{
  ...
  const int alpha = Gui::selection->getAlpha();
...
void Selection::release(View *view)
{
  ...
  {
    state = STATE_RESIZE;
    Gui::selection->copyEnable(true);
    Gui::selection->cropEnable(true);
  }
...
void Selection::reset()
{
  ...
  Gui::selection->values(0, 0, 0, 0);
  Gui::selection->copyEnable(false);
  Gui::selection->pasteEnable(false);
  Gui::selection->cropEnable(false);
