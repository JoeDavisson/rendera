...
namespace
{
  void cb_left(Fl_Widget *, void *data)
  { OffsetOptions *temp = (OffsetOptions *)data; temp->left(); }

  void cb_right(Fl_Widget *, void *data)
  { OffsetOptions *temp = (OffsetOptions *)data; temp->right(); }

  void cb_up(Fl_Widget *, void *data)
  { OffsetOptions *temp = (OffsetOptions *)data; temp->up(); }

  void cb_down(Fl_Widget *, void *data)
  { OffsetOptions *temp = (OffsetOptions *)data; temp->down(); }
}
