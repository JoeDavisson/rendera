...
namespace
{
  void cb_zoomIn(Fl_Widget *, void *data)
  { ViewOptions *temp = (ViewOptions *)data; temp->zoomIn(); }

  void cb_zoomOut(Fl_Widget *, void *data)
  { ViewOptions *temp = (ViewOptions *)data; temp->zoomOut(); }
 
  void cb_zoomOne(Fl_Widget *, void *data) 
  { ViewOptions *temp = (ViewOptions *)data; temp->zoomOne(); }

  void cb_gridEnable(Fl_Widget *, void *data)
  { ViewOptions *temp = (ViewOptions *)data; temp->gridEnable(); }

  void cb_gridSnap(Fl_Widget *, void *data)
  { ViewOptions *temp = (ViewOptions *)data; temp->gridSnap(); }

  void cb_gridX(Fl_Widget *, void *data)
  { ViewOptions *temp = (ViewOptions *)data; temp->gridX(); }

  void cb_gridY(Fl_Widget *, void *data)
  { ViewOptions *temp = (ViewOptions *)data; temp->gridY(); }

  void cb_aspectMode(Fl_Widget *, void *data)
  { ViewOptions *temp = (ViewOptions *)data; temp->aspectMode(); }
}
