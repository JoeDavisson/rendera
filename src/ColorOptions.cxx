...
namespace
{
  void cb_colorChange(Fl_Widget *, void *data) { ColorOptions *temp = (ColorOptions *)data; temp->colorChange(); }

  void cb_colorHexInput(Fl_Widget *, void *data) { ColorOptions *temp = (ColorOptions *)data; temp->colorHexInput(); }

  void cb_colorTrans(Fl_Widget *, void *data) { ColorOptions *temp = (ColorOptions *)data; temp->colorTrans(); }

  void cb_colorTransInput(Fl_Widget *, void *data) { ColorOptions *temp = (ColorOptions *)data; temp->colorTransInput(); }

  void cb_paletteSwatches(Fl_Widget *, void *data) { ColorOptions *temp = (ColorOptions *)data; temp->paletteSwatches(); }

  void cb_paletteInput(Fl_Widget *, void *data) { ColorOptions *temp = (ColorOptions *)data; temp->paletteInput(); }
}
