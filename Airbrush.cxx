...
void Airbrush::render_begin_normal(View *view)
{
...
void Airbrush::render_begin_smooth(View *view)
{
  Brush *brush = Brush::main;
  Map *map = Map::main;
...
int Airbrush::render_callback_normal(View *view)
{
  Brush *brush = Brush::main;
  Map *map = Map::main;
...
int Airbrush::render_callback_smooth(View *view)
{
  Brush *brush = Brush::main;
  Map *map = Map::main;
...
int Airbrush::render_callback(View *view)
{
  Brush *brush = Brush::main;
  Map *map = Map::main;
...
void Airbrush::release(View *view)
{
  if(active && stroke->type != 3)
  {
    stroke->end(view->imgx, view->imgy, view->ox, view->oy, view->zoom);
